...
int find_naive(int* vector, int size, int value){
        int index = -1 ;
...
int find_no_break(int* vector, int size, int value){
        int index = -1 ;
        for (int i = 0 ; i < size ; i++){
                if (vector[i] == value){
                        index = i ;
...
int find_compare(int* vector, int size, int value){
        int index = -1 ;
        for (int i = 0 ; i < size ; i++){
...
int find_std_find(int* vector, int size, int value){
...
int find_intrinsic(int* vector, int size, int value){
        // experimental
        int index = -1 ;
